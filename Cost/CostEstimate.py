...
W_airframe =  477 * lbs  # [lbs] Weight of structure
...
cpi = 1.021 * 1.015 * 1.0001 * 1.013 * 1.021 * 1.024 * 1.018 * 1.012 * 1.047*1.08*1.086
euro = 0.93
...
price_per_kwh = 750
capacity = 59.1
batteries = price_per_kwh * capacity/euro *0.8
...
fuel = elec*capacity*0.85*250 +batteries/2
