...
class MassMethods:
    ...
    def cessna(self):
        ...
        mass_gear = (0.013 * (self.mass_takeoff_1 * self.kg_to_pounds)
                     + 0.362 * (self.mass_takeoff_1 * self.kg_to_pounds) ** 0.417 * self.gear_load_factor ** 0.950 * (self.gear_length * self.meters_to_feet) ** 0.183
                     + 6.2 + 0.0013 * (self.mass_takeoff_1 * self.kg_to_pounds) + 0.007157 * (self.mass_takeoff_1 * self.kg_to_pounds) ** 0.749 * self.gear_load_factor * (self.gear_length * self.meters_to_feet) ** 0.788
    ...
    def usaf(self):
        ...
        mass_v_tail = (98.5 * (((self.load_factor_ultimate * self.mass_takeoff_1 * self.kg_to_pounds) / (10 ** 5)) ** 0.87
